...
static.data=[1500,1500,1500,1500]

thrust1=0
thrust2=0
thrust = [1500,1500,1500,1500] # [heave 1,heave 2,surge 1,surge 2]
...
def callback0(msg):
    global thrust
    thrust[2] = float(msg.data)
    thrust[3] = float(msg.data)
...
rospy.Subscriber('thrust_surge',Int32,callback0)
