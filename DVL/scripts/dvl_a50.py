...
class DVL_A50(Node):
    ...
    def __init__(self):
        ...
        self.dvl_publisher1_ = self.create_publisher(DVL, '/dvl/data1', 10)
        self.dvl_publisher1_pos = self.create_publisher(DVLDR, '/dvl/position1', 10)
        self.dvl_publisher2_ = self.create_publisher(DVL, '/dvl/data2', 10)
        self.dvl_publisher2_pos = self.create_publisher(DVLDR, '/dvl/position2', 10)
    ...
    def publish_data(self, data):
        ...
        if 'time' in data:
            ...
            if self.my_param == "192.168.0.80":
                self.dvl_publisher1_.publish(theDVL)
            elif self.my_param == "192.168.0.81":
                self.dvl_publisher2_.publish(theDVL)
        ...
        if 'ts' in data:
            ...
            if self.my_param == "192.168.0.80":
                self.dvl_publisher1_pos.publish(DVLDeadReckoning)
            elif self.my_param == "192.168.0.81":
                self.dvl_publisher2_pos.publish(DVLDeadReckoning)
